...
**Software Stack:** Rocky Linux 9 · Suricata (inline IPS) · Zeek (network analysis) · OpenVPN
...
|---|---|---|
| Active Directory Administration | Windows Server 2025, PowerShell, ADUC | Proficient |
| Security Assessment | PingCastle, BloodHound CE, SharpHound | Proficient |
| SIEM Administration | Splunk Enterprise, SPL queries, Dashboards | Proficient |
| Endpoint Detection | Sysmon, Splunk Add-on for Sysmon | Proficient |
| Identity Management | LAPS, GPO, Privileged Account Management | Proficient |
| Containerisation | Docker Engine, WSL2, docker-compose | Competent |
| Linux Administration | Ubuntu, Rocky Linux, bash | Competent |
| Network Security | Suricata, Zeek, TAP monitoring | In Progress |
| Scripting | PowerShell, Bash | Proficient |
| Documentation | GitHub, Portfolio writing | Proficient |
...
|---|---|
| Cybersecurity Bootcamp | HyperionDev – Manchester Metropolitan University |
| Police Academy | Police Academy of Latvia |
| Defence Academy | Defence Academy of Latvia |
| Language Skills | Native Russian, Latvian; English |
| Investigative Experience | Background in investigative work |
| Secure Environment | Experience in SC (Security Cleared) environments |

> Unique combination of technical cybersecurity skills with investigative and defence background — particularly relevant for threat intelligence, SOC analyst, and government/defence cybersecurity roles.
